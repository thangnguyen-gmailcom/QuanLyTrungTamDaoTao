...
//
//    @PostMapping("/")
//    public String updatePassword(@Valid @ModelAttribute User user, BindingResult bindingResult, RedirectAttributes redirectAttributes){
//        new UserValidator().validate(user, bindingResult);
//        if (bindingResult.hasFieldErrors()) {
//            return "manager-page/profile";
//        }else {
